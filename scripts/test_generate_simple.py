...
for node in workflow['nodes']:
    ...
    elif node.get('id') == 8:  # KSampler
        if 'widgets_values' in node:
            node['widgets_values'][2] = config['default_settings']['steps']
            node['widgets_values'][3] = config['default_settings']['cfg']
