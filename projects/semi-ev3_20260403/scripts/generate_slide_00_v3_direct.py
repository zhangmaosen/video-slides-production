#!/usr/bin/env python3
"""
生成 slide_00 v3 - 直接调用 ComfyUI API
"""
import json
...
# 读取提示词
with open(os.path.join(PROJECT_DIR, "prompts/slide_00_positive_v3.txt"), 'r', encoding='utf-8') as f:
    positive_prompt = f.read().strip()

with open(os.path.join(PROJECT_DIR, "prompts/slide_00_negative_v3.txt"), 'r', encoding='utf-8') as f:
    negative_prompt = f.read().strip()

print("="*60)
print("生成 slide_00 v3 图片")
print("="*60)
