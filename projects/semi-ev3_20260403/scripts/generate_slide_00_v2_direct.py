#!/usr/bin/env python3
"""
生成 slide_00 v2 - 直接调用 ComfyUI API
"""
import json
...
# 读取提示词
with open(os.path.join(PROJECT_DIR, "prompts/slide_00_positive_v2.txt"), 'r', encoding='utf-8') as f:
    positive_prompt = f.read().strip()

with open(os.path.join(PROJECT_DIR, "prompts/slide_00_negative_v2.txt"), 'r', encoding='utf-8') as f:
