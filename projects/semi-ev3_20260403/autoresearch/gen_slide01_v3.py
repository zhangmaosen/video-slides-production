...
# slide_01 v3 prompt - 强调手绘风格 + 完整标注
positive_prompt = """混子说手绘漫画风格，简笔画插画，水墨灰阶线条，笔触随意有活力。
...
手绘线条艺术，笔触可见，不是 AI 生成。"""

negative_prompt = """AI 生成，数字渲染，3D渲染，Hyper-realistic，光滑渲染，金属反光，阴影细节
            ...
            for node_id, node_output in history[task_id].get('outputs', {}).items():
                if 'images' in node_output:
                    for img in node_output['images']:
                        ...
                        with open('projects/semi-ev3_20260403/slides/slide_01_v3.png', 'wb') as f:
