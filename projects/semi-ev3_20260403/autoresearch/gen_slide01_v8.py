...
# slide_01 v8 prompt - 字体加大 + 正负向 prompt 双管齐下
...
电池组、驱动电机、线束悬浮拆解，用大圆圈 + 粗箭头指向关键部位。
...
**文字渲染（必须准确）：**
- 上方大号白色粗体字："开场爆点"（字体极大，清晰可见）
- 指向电池位置：大号红圈 + "电池"（字体极大）
- 指向电机位置：大号红圈 + "电"（字体极大）
- 指向产能位置：大号红圈 + "5万/年"（字体极大）
...
电波组，电池组错误，电字错误，产能错误，5万台/年 错误

文字错别字，文字乱码，模糊文字，奇怪符号，小字体文字

错误文字列表：电波，屯年，万年，5个屯，年产，5台产能"""
            ...
            for node_id, node_output in history[task_id].get('outputs', {}).items():
                if 'images' in node_output:
                    for img in node_output['images']:
                        ...
                        with open('projects/semi-ev3_20260403/slides/slide_01_v8.png', 'wb') as f:
