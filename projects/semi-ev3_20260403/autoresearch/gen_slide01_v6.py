...
# slide_01 v6 prompt - 极度强调手绘风格
positive_prompt = """Hand-drawn sketch on paper, pencil drawing, visible paper texture, charcoal strokes, rough sketch lines, comic ink illustration, NOT digital, NOT AI, NOT photorealistic.

正面仰拍视角。

画面中央：一辆 Tesla Semi 电动重卡正面特写，高光珍珠白涂装，哑光黑色覆盖式侧裙。巨大子弹头驾驶室向上延伸。封闭式前脸无进气格栅。极简 T 字形标志在车头正中央。流线型薄型电子后视镜。全景挡风玻璃。深蓝色 LED 灯带。

电池组、驱动电机、线束悬浮拆解，标注清晰：
- "电"
- "电池组"
- "产能"
...
negative_prompt = """AI generated, digital rendering, 3D render, photorealistic, smooth rendering, hyperrealistic, metal reflections, digital art

低画质，肢体畸形，手指畸形，过饱和，蜡像感，人脸无细节，过度光滑

银灰色车身，传统卡车造型，侧裙外露机械管路

Serni，Tesua，TSELA 拼写错误
            ...
            for node_id, node_output in history[task_id].get('outputs', {}).items():
                if 'images' in node_output:
                    for img in node_output['images']:
                        ...
                        with open('projects/semi-ev3_20260403/slides/slide_01_v6.png', 'wb') as f:
