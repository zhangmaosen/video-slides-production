...
# 读取新的 slide_01_final.txt 提示词
with open('projects/semi-ev3_20260403/prompts/slide_01_final.txt', 'r') as f:
            ...
            for node_id, node_output in history[task_id].get('outputs', {}).items():
                if 'images' in node_output:
                    for img in node_output['images']:
                        ...
                        with open('projects/semi-ev3_20260403/slides/slide_01_v10.png', 'wb') as f:
