...
# 读取优化后的 slide_02 提示词 v2
with open('projects/semi-ev3_20260403/prompts/slide_02_optimized_v2.txt', 'r') as f:
            ...
            for node_id, node_output in history[task_id].get('outputs', {}).items():
                if 'images' in node_output:
                    for img in node_output['images']:
                        ...
                        with open('projects/semi-ev3_20260403/slides/slide_02_v3.png', 'wb') as f:
