...
# slide_01 v4 prompt - 强烈强调手绘风格
positive_prompt = """Hand-drawn sketch style, pencil illustration, ink wash grayscale lines, visible brush strokes, loose energetic lines, NOT AI generated.

正面仰拍视角。

画面中央：一辆 Tesla Semi 电动重卡正面特写，高光珍珠白涂装，哑光黑色覆盖式侧裙。巨大子弹头驾驶室向上延伸。封闭式前脸无进气格栅。极简 T 字形标志在车头正中央。流线型电子后视镜。全景挡风玻璃。深蓝色 LED 灯带。
            ...
            for node_id, node_output in history[task_id].get('outputs', {}).items():
                if 'images' in node_output:
                    for img in node_output['images']:
                        ...
                        with open('projects/semi-ev3_20260403/slides/slide_01_v4.png', 'wb') as f:
